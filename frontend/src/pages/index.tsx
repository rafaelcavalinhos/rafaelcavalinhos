...
export default function Home() {
  ...
  return (<>
    ...
    <div id="home" className="hidden lg:block bg-white">
      ...
      {/* Header */}
      <header className="z-50 fixed flex flex-row justify-between items-center w-full py-4 px-10 border-b-2 border-gray-200 bg-white">
        ...
        <FlexCol className="w-full">
          ...
          <FlexRow className="justify-between h-screen pt-24 px-20">
            <FlexCol className="font-bold text-6xl justify-center items-start gap-y-10">
              <h1>Hello!<br />I'm <span className="text-gradient">Rafael Cavalinhos</span>,<br />a Full-Stack Developer</h1>
            ...
            <FlexCenter className="pr-20">
              <Image src="/cat.gif" alt="me" width={500} height={500} className="rounded-full shadow-2xl hover:scale-105 transition"/>
          ...
          <FlexCol id="projects" className="items-center gap-y-4 mt-50 bg-gray-50 w-full py-20 px-20">
